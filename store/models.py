...
class Medicine(models.Model):
    ...
    hospital = models.ForeignKey(HospitalUser, related_name='medicine_hospital_user', on_delete=models.CASCADE)
...
class MainMedicalStoreMedicineTransactionHistory(models.Model):
    ...
    mapping_medicine = models.ForeignKey(MappingMedicine, on_delete=models.CASCADE)
