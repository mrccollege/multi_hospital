# Generated by Django 3.2.23 on 2023-11-23 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_now_add=True)),
                ('updated_at', models.DateField(null=True)),
                ('from_mini_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MainStoreMedicine_from_mini_store', to='accounts.stores')),
